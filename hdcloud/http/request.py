...
class Request(object):
    ...
    def get(self, url, headers=None, params=None, proxies=None, timeout=None, except_fun=None):
        '''
        GET请求
        :param url:
        :param headers: 请求头
        ...
        return self.get_response(res, except_fun)

    def post(self, url, headers=None, data=None, proxies=None, timeout=None, except_fun=None):
        '''
        POST请求
        :param url:
        :param headers: 请求头
    ...
    def get_response(self, res, except_fun=None):
        """
        获取响应内容
